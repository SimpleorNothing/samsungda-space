...
// 설정되면 방문자는 공동 현관 비밀번호 입력 후에만 로비·방·뷰어·API에 접근할 수 있습니다.
// 현관을 통과하면 원래 가려던 경로로 복귀하며, 개별 방의 열람 비밀번호는 그 위에서 별도로 동작합니다.
// 비밀번호 평문은 저장하지 않고(쿠키에는 SHA-256 해시만), 비교 시점에만 해시 대조합니다.
import { sha256, getCookie, escapeHtml, BASE_CSS } from './_lib.js';
