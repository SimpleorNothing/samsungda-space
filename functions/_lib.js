...
.badge{display:inline-block;font-size:15px;font-weight:600;padding:3px 9px;border-radius:7px}
...
.md-body code{background:#f6f7f9;border:1px solid #e6e9ee;border-radius:4px;padding:1px 5px;font-size:15px}
