...
(function () {
  ...
  var T = { bg:cssVar('--surface',cssVar('--panel','#ffffff')), surface:cssVar('--paper',cssVar('--bg','#f6f7f9')), text:cssVar('--text',cssVar('--ink','#1a1d21')), muted:cssVar('--muted','#5b6470'), border:cssVar('--border',cssVar('--line','#e6e9ee')), brand:cssVar('--brand',cssVar('--new','#1257d6')) };
